...
This is the web UI for [`DeepMed-RLX`](https://github.com/bytedance/deer-flow).

## Quick Start

### Prerequisites

- [`DeepMed-RLX`](https://github.com/bytedance/deer-flow)
- Node.js (v22.14.0+)
...
DeepMed-RLX Web UI uses `pnpm` as its package manager.
...
DeepMed-RLX is built upon the foundation of these outstanding projects:
